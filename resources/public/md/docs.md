...
Two middleware functions by default which are are located in the `ltest.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `ltest.handler` namespace to manage the enabled middleware.
